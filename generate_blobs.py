...
def main():
    ...
    output_dir = os.path.join(os.path.dirname(
        os.path.dirname(args.elf_path)), "BLOB")
    ...
    tmpl_name_list = [
        ("c_blob.tmpl", data_dict["name"]+"_blob.c"),
        ("bin_blob.tmpl", "temp_blob.txt")
    ]
    temp_path=""
    ...
    output_path = os.path.join(output_dir, data_dict["name"]+"_blob.b")
    algo.process_data(output_path,temp_path,data_dict)
